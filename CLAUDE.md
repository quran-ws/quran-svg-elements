...
`b91d39e1`, living in a sibling worktree that `QSVG_ROOT` points at; its ~722 modified
...
cd quran-svg
git checkout main            # b91d39e1 "Centre every ayah medallion's ring on its numeral (#9)"
...
above rebuilds the same line structure from a clean `b91d39e1`.
