...
| | pinned baseline | now |
|---|---|---|
| Flagged words (mark audit) | 559 | **79** |
| Interval-audit flags | 172 | **56** |
| Pages clean (marks+intervals) | 276 | **525** of 604 |
...
so they are not comparable to today's. Current sweep: `.cache/sweeps/i39full`
