...
holds a damma in path 5 (23.2 u²) and a sukun plus its whole body in path 6
...
named marks lived (p377, p418, p446, p507; fatha 20, kasra 20, wasla 12, sukun
8, dot 8, shadda 7, two-dots 4).
...
2. **HDRGUARD now requires the ink to be IN the header band.** With p446's
   ...
   |---|---|---|---|---|---|---:|
   | above | 446 | 37:2:1 | two-dots | 95.2–97.9 | 49.7–74.1 | **21.0** |
   | above | 570 | 71:1:5 | small-ya | 241.2–245.8 | 194.3–218.8 | **22.3** |
   | below | 570 | 70:44:5 | small-alef | 129.3–135.3 | 158.5–182.1 | **23.1** |
   | above | 359 | 25:1:6 | small-ya | 456.7–461.4 | 408.6–433.1 | **23.7** |
   | below | 570 | 70:44:4 | dammatan | 120.6–127.0 | 158.5–182.1 | **31.5** |
...
- `tools/build_annotations.py` — the ayah-marker regex assumed
  `class="ayah-marker" data-aid=` were adjacent. The marker group has since
...
| `tools/audit_taxonomy.py` | OK | **OK** — 35 mark names, 3 muanaqah pairs, sifr 3970/66 |
