...
2. **The density hill-climb ejected the word to line 7** (traced with the new
   ...
   grabbed جَآءَكَ's first piece and its fathahs.
...
| جَآءَكَ | 2/3 pieces, fathah 2/3 | all pieces + 3 fathahs back |
...
`بَعْدَ مَا fathah 2/3` — the third fathah sits at x≈48–52 held by أَهْوَآءَهُم
under the name dammah (the one interval flag left); `جَآءَكَ ligatures 4/3` — a
7.1×3.6 fathah-shaped outline at x310.8 counted as a body (letter-vs-mark
family).
...
| **272** | 16:50 | **overline renamed `kasrah`, counted in ظِلَـٰلُهُۥ (16:48:10) — the page's only mark flag** | bar ejection now accepts a renamed hairline (h<2.5 ≤ w) and drops the name |
...
that were never the words' (the p272 fake kasrah, the p589 ۩). Bench 79, no
